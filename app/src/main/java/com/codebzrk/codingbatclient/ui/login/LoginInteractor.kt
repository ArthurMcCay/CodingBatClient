...
interface LoginInteractor {
    ...
    fun performLogin(listener: OnFinishedListener, email: String, password: String)

    fun performLogin(listener: OnFinishedListener)

    fun checkIfLoginDataIsPresent(): Boolean
